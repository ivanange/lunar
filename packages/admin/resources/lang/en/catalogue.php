...
return [
     ...
     * Categories.
     */
    'collections.sidemenu.create_btn' => 'Create category group',
    'collections.sidemenu.modal.title' => 'Create category group',
    'collections.sidemenu.modal.btn' => 'Create category group',
    'collections.sidemenu.menu_title' => 'Category Groups',
    'collections.groups.delete_group_btn' => 'Delete category group',
    'collections.groups.add_collection_btn' => 'Add category',
    'collections.groups.delete.title' => 'Delete category group',
    'collections.groups.delete.strapline' => 'Are you sure you want to delete this category group?',
    'collections.groups.delete.warning' => 'All categories within this group will also be removed.',
    'collections.groups.delete.confirm' => 'Confirm you want to delete the category group and all associated categories',
    'collections.groups.delete.btn' => 'Delete category group',
    'collections.groups.move.title' => 'Move Category',
    'collections.groups.move.search_placeholder' => 'Search for a category to use for parent',
    'collections.groups.move.alert' => 'This will move :source into :target.',
    'collections.groups.move.btn' => 'Move Category',
    'collections.groups.node.make_root' => 'Make Root',
    'collections.groups.node.move' => 'Move Category',
    'collections.groups.node.edit' => 'Edit Category',
    'collections.groups.node.add_child' => 'Add Child Category',
    'collections.groups.node.delete' => 'Delete Category',
    'collections.groups.no_groups' => 'Looks like you don\'t have any Category Groups set up.',
    'collections.create.child.title' => 'Add category to :parent.',
    'collections.create.root.title' => 'Add top-level category',
    'collections.create.btn' => 'Create Category',
    'collections.delete.title' => 'Delete Category',
    'collections.delete.btn' => 'Delete Category',
    'collections.delete.warning' => 'All child categories will also be removed.',
    'collections.delete.child.warning' => 'This category has :count child categories, these will also be lost as well.',
    'collections.delete.root.warning' => 'Are you sure you want to remove this category?',
    'collections.index.title' => 'Categories',
    'collections.show.save_btn' => 'Save Category',
    ...
    'collections.show.no_products' => 'This category has no products associated.',
    'collections.show.no_children' => 'This category has no child categories.',
    'collections.associate_to_other_products' => 'Choose products to associate and relate to this product.',
    'collections.static_collections' => 'Static Categories',
