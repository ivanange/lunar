...
return [
     ...
     * Catégories.
     */
    'collections.sidemenu.create_btn' => 'Create catégorie group',
    'collections.sidemenu.modal.title' => 'Create catégorie group',
    'collections.sidemenu.modal.btn' => 'Create catégorie group',
    'collections.sidemenu.menu_title' => 'Catégorie Groups',
    'collections.groups.delete_group_btn' => 'Delete catégorie group',
    'collections.groups.add_collection_btn' => 'Add catégorie',
    'collections.groups.delete.title' => 'Delete catégorie group',
    'collections.groups.delete.strapline' => 'Are you sure you want to delete this catégorie group?',
    'collections.groups.delete.warning' => 'All collections within this group will also be removed.',
    'collections.groups.delete.confirm' => 'Confirm you want to delete the catégorie group and all associated collections',
    'collections.groups.delete.btn' => 'Delete catégorie group',
    'collections.groups.move.title' => 'Move Catégorie',
    'collections.groups.move.search_placeholder' => 'Search for a catégorie to use for parent',
    'collections.groups.move.alert' => 'This will move :source into :target.',
    'collections.groups.move.btn' => 'Move Catégorie',
    'collections.groups.node.make_root' => 'Make Root',
    'collections.groups.node.move' => 'Move Catégorie',
    'collections.groups.node.edit' => 'Edit Catégorie',
    'collections.groups.node.add_child' => 'Add Child Catégorie',
    'collections.groups.node.delete' => 'Delete Catégorie',
    'collections.groups.no_groups' => 'Looks like you don\'t have any Catégorie Groups set up.',
    'collections.create.child.title' => 'Add catégorie to :parent.',
    'collections.create.root.title' => 'Add top-level catégorie',
    'collections.create.btn' => 'Create Catégorie',
    'collections.delete.title' => 'Delete Catégorie',
    'collections.delete.btn' => 'Delete Catégorie',
    'collections.delete.warning' => 'All child collections will also be removed.',
    'collections.delete.child.warning' => 'This catégorie has :count child collections, these will also be lost as well.',
    'collections.delete.root.warning' => 'Are you sure you want to remove this catégorie?',
    'collections.index.title' => 'Catégories',
    'collections.show.save_btn' => 'Save Catégorie',
    ...
    'collections.show.no_products' => 'This catégorie has no products associated.',
    'collections.show.no_children' => 'This catégorie has no child collections.',
    'collections.associate_to_other_products' => 'Choose products to associate and relate to this product.',
    'collections.static_collections' => 'Static Catégories',
     ...
     * Orders.
     */
    'orders.show.customer_reference' => 'Reference Client',
