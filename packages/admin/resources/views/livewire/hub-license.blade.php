      ...
      <div class="p-2 @if($unlicensed) bg-red-600 @endif rounded-lg shadow-lg sm:p-1">
        <div class="flex flex-wrap items-center justify-between">
          ...
          <div class="flex-shrink-0 order-3 w-full mt-2 sm:order-2 sm:mt-0 sm:w-auto">
            <a href="#"
              class="flex items-center justify-center px-4 py-2 text-xs font-medium text-white bg-red-800 border border-transparent rounded-md shadow-sm hover:bg-red-50">
              @if($unlicensed)
