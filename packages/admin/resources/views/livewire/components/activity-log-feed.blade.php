    ...
    <div class="flex items-center gap-4 mt-4">
        ...
        <form class="relative w-full" wire:submit.prevent="addComment">
            <textarea class="w-full pl-4 pr-32 pt-5 border border-gray-200 rounded-lg h-[58px] sm:text-sm form-text"
                type="text" placeholder="Add a comment" wire:model.defer="comment" required multiline></textarea>
                ...
                <li class="relative py-8 ml-5">
                    ...
                    <ul class="mt-4 space-y-6">
                        ...
                        <li class="relative pl-8">
                            <div @class([ 'absolute top-[2px]' , '-left-[calc(0.75rem_-_1px)]'=> $item['log']->causer,
                                ...
                                @else
                                <span @class([ 'absolute w-4 h-4 rounded-full ring-4 bg-gray-300 ring-gray-200'
                                    , '!bg-primary-500 !ring-primary-100'=> $item['log']->description == 'created',
                            ...
                            <div @class([ 'flex justify-between' , 'pt-[5px]'=> $item['log']->causer,
