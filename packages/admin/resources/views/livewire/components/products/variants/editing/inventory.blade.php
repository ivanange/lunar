  ...
  <div class="flex-col px-4 py-5 space-y-4 bg-white sm:p-6">
    ...
    <div class="space-y-4">
      ...
      <div class="grid grid-cols-3 gap-4">
        <x-hub::input.group label="Purchasability" instructions="Set the condition this is available to purchase."
          for="sku">
          <div>
            <x-hub::input.select>
        ...
        <x-hub::input.group label="Min Purchase Quantity" instructions="The minimum amount that can be purchased"
          for="sku">
          <x-hub::input.text type="number" value="1" />
        </x-hub::input.group>

        <x-hub::input.group label="Min Batch Quantity" instructions="This product can only be ordered in multiples of 1"
          for="sku">
          <x-hub::input.text type="number" value="1" />
        </x-hub::input.group>
      </div>
      ...
      <x-hub::input.group label="Stock Level" for="sku">
        <div class="grid grid-cols-3 text-sm">
          ...
          <a href="#" class="text-primary-500 hover:underline">{{ __('adminhub::global.edit_stock') }}</a>
        </div>
