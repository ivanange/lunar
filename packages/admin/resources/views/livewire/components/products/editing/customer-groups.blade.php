<div class="space-y-4">
  ...
  <div class="divide-y divide ">
    <div class="grid items-center grid-cols-12 gap-4 py-2 text-sm" x-data="{ scheduling: false, scheduled: false }">
      <div class="col-span-5">
        ...
        <p class="text-xs text-gray-500" x-show="scheduled">{{
          __('adminhub::catalogue.editing.customer-groups.publish_on') }}
          {{ now()->addDays(2)->format('d/m/Y H:ma') }}.</p>
      </div>
      <div class="col-span-6">
        <a href="#" x-show="!scheduling" @click.prevent="scheduling = true" class="text-primary-500 hover:underline">
    ...
    <div class="grid items-center grid-cols-12 gap-4 py-2 text-sm" x-data="{ scheduling: false, scheduled: false }">
      ...
      <div class="col-span-6">
        {{-- <a href="#" x-show="!scheduling" @click.prevent="scheduling = true"
          class="text-primary-500 hover:underline">Schedule availability</a>
        <div x-show="scheduling">
          <x-hub::input.datepicker placeholder="Schedule publish date." />
        </div> --}}
        {{--
