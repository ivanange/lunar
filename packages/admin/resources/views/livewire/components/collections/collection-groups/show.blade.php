    ...
    <div wire:loading.remove wire:target="deleteGroup">
        ...
        <div class="mt-4">
                ...
                <x-slot name="content">
                    <div class="space-y-4">
                        <x-hub::input.group :label="__('adminhub::inputs.name')" for="name"
                            :error="$errors->first('collection.name')" required>
            ...
            <x-hub::modal.dialog wire:model="collectionMove.source">
                ...
                <x-slot name="content">
                    <div class="relative">
                        <x-hub::input.text wire:model="searchTerm" :placeholder="__(
                        ...
                        <div class="absolute w-full overflow-y-scroll bg-white rounded-b shadow max-h-64 z-10">
                            ...
                            <button type="button"
                                ...
                                <strong class="rounded px-1.5 py-0.5 bg-primary-50 text-xs text-primary-600">
                                ...
                                <span class="text-gray-500 flex gap-1.5 items-center">
                                    ...
                                    <x-hub::icon ref="chevron-right" class="w-4 h-4" style="solid" />
                                </span>
                                @endif
            ...
            <x-hub::modal.dialog wire:model="collectionToRemoveId" form="deleteCollection">
                ...
                <x-slot name="footer">
                    <div class="flex justify-between">
                        <x-hub::button type="button" wire:click.prevent="$set('collectionToRemoveId', null)"
                            theme="gray">
                            {{ __('adminhub::global.cancel') }}
                        </x-hub::button>
