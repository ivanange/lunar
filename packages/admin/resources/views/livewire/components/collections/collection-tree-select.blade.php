<div>
    <div class="grid grid-cols-6 gap-4 p-2 border border-b-0 rounded-t">
        <div class="col-span-4">
            <x-hub::input.text wire:model.debounce="searchTerm" placeholder="Search by collection name" />
        </div>
        <div class="col-span-2">
            <x-hub::input.select for="group" wire:model="collectionGroupId"
                :disabled="!!$this->searchTerm || $showOnlySelected">
    ...
    <div class="rounded-b border h-full overflow-y-scroll max-h-96 bg-gray-50">
        ...
        <div class="bg-gray-100 py-1 px-2 text-sm border-b text-gray-700">
            ...
            <a href="#" class="text-primary-600 hover:underline" wire:click.prevent="toggleSelected">
