<div class="space-y-8">
    ...
    <div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-2 lg:gap-6 mt-2">
            <div>
                <div class="flex items-center h-24 p-4 bg-white rounded-lg shadow">
                    <div class="hidden md:block">
                        <div
                            class="flex items-center justify-center w-12 h-12 ml-2 bg-primary-200 text-green-400 rounded-full">
            ...
            <div>
                <div class="flex items-center h-24 p-4 pr-0 bg-white rounded-lg shadow">
                    <div class="hidden md:block">
                        <div class="flex items-center justify-center w-12 h-12 ml-2 rounded-full bg-primary-50">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
    ...
    <div>
        <div class="xl:flex space-y-4 xl:space-y-0 flex-row">
            <div class="basis-full flex-grow">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="pt-4 text-sm text-center">
                                        {{ optional($order->placed_at)->translatedFormat('jS F Y H:m') }}
                                    </td>
