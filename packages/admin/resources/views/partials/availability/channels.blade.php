...
<div class="grid items-center grid-cols-12 gap-4 py-2 text-sm">
    ...
    <div class="col-span-7">
        ...
        <button type="button" class="text-primary-500 hover:underline"
            wire:click="$set('availability.channels.{{ $channel->id }}.scheduling', true)">
        ...
        <x-hub::modal.dialog wire:model="availability.channels.{{ $channel->id }}.scheduling">
            ...
            <x-slot name="content">
                <div class="space-y-4">
                    <x-hub::input.group
                        ...
                        <div class="flex">
                            <div class="w-full mr-4">
                                <x-hub::input.datepicker id="starts_at"
                                    wire:model="availability.channels.{{ $channel->id }}.starts_at"
                    ...
                    <x-hub::input.group
                        ...
                        <div class="flex">
                            <div class="w-full mr-4">
                                <x-hub::input.datepicker id="ends_at"
                                    wire:model="availability.channels.{{ $channel->id }}.ends_at"
                                    :options="[ 'enableTime' => true ]" />
                            </div>
            ...
            <x-slot name="footer">
                <x-hub::button type="button"
                    wire:click="$set('availability.channels.{{ $channel->id }}.scheduling', false)">
    ...
    <div class="col-span-3">
        <x-hub::input.toggle wire:model="availability.channels.{{ $channel->id }}.enabled" />
    </div>
</div>
@endforeach
