                    ...
                    <div class="flex items-center px-4 py-2 text-sm border rounded">
                        ...
                        <div class="flex grow">
                            <div class="grow flex gap-1.5 flex-wrap items-center">
                                <strong class="rounded px-1.5 py-0.5 bg-primary-50 text-xs text-primary-500">
                                ...
                                <strong class="text-gray-700 truncate max-w-[40ch]" title="{{ $collection['name'] }}">
                                    {{ $collection['name'] }}
                                </strong>
                            </div>
            ...
            <div class="space-y-2">
                ...
                <div wire:key="brand_{{ $index }}">
                    <div class="flex items-center px-4 py-2 text-sm border rounded">
                        ...
                        <div class="flex grow">
                            <div class="grow flex gap-1.5 flex-wrap items-center">
                                <strong class="text-gray-700 truncate max-w-[40ch]" title="{{ $brand['name'] }}">
                                    {{ $brand['name'] }}
                                </strong>
                            </div>
            ...
            <div class="space-y-2">
                ...
                <div wire:key="product_{{ $index }}">
                    <div class="flex items-center px-4 py-2 text-sm border rounded">
                        ...
                        <div class="flex grow">
                            <div class="grow flex gap-1.5 flex-wrap items-center">
                                <strong class="text-gray-700 truncate max-w-[40ch]" title="{{ $product['name'] }}">
                                    {{ $product['name'] }}
                                </strong>
                            </div>
