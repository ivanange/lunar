<ul class="space-y-4">
  ...
  <li @class([ 'text-sm rounded-lg shadow-sm border shadow'=> true,
    'border-orange-300' => $transaction->type == 'refund',
    'border-primary-300' => $transaction->type == 'intent',
    ...
    <div class="p-2 space-y-2">
      ...
      <div class="px-4 py-2 bg-white shadow-sm rounded flex items-center justify-between">
        ...
        <div class="flex space-x-2">
          <div @class([ 'rounded flex items-center py-1 px-2 rounded-md text-xs'=> true,
            'text-primary-500 bg-primary-50' => $threeD->address ?? false,
          ...
          <div @class([ 'rounded flex items-center py-1 px-2 rounded-md text-xs'=> true,
            'text-primary-500 bg-primary-50' => $threeD->postalCode ?? false,
          ...
          <div @class([ 'rounded flex items-center py-1 px-2 rounded-md text-xs'=> true,
            'text-primary-500 bg-primary-50' => $threeD->securityCode ?? false,
    ...
    <div class="
        ...
        @if($transaction->type == 'intent') bg-primary-50 border-primary-300 text-primary-500 @endif
