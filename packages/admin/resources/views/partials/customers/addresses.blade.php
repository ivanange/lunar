    ...
    <div wire:key="address_{{ $address->id }}" class="leading-relaxed bg-white rounded shadow">
      <div class="flex justify-between px-4 py-3 rounded-t bg-gray-50">
        <div class="space-x-1">
          ...
          <span class="px-3 py-1 text-xs text-primary-500 bg-primary-50">Billing Default</span>
          @endif
        ...
        <div class="flex space-x-4">
          <x-hub::button theme="gray" size="xs" wire:click.prevent="$set('addressIdToEdit', '{{ $address->id }}')">Edit
          </x-hub::button>
