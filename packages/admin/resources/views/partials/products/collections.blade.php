    ...
    <div class="space-y-4">
      <div>
        ...
        <div class="relative">
          ...
          <input class="block w-full px-4 py-3 pl-10 text-sm border border-t-0 bg-gray-50"
            placeholder="Search for collections" />
        </div>
        <div class="border border-t-0 rounded-b">
          <div class="grid items-center grid-cols-12 p-4 text-sm">
            <div class="col-span-11">
              <a class="block text-sm text-primary-500 truncate hover:underline" href="#">{{
                __('adminhub::catalogue.collections.summer_seasonal') }}</a>
            </div>
