      ...
      <div class="space-y-4">
        ...
        <div>
          <x-hub::button theme="gray" type="button" wire:click="$set('showImageSelectModal', true)">{{
            __('adminhub::menu.product.choose-existing-btn') }}</x-hub::button>
            ...
            <x-slot name="content">
              <div class="grid grid-cols-3 gap-4">
                ...
                <label class="cursor-pointer">
                  <input wire:model="imageToSelect" name="imageToSelect" value="{{ $productImage->id }}"
            ...
            <x-slot name="footer">
              <div class="flex justify-end space-x-4">
                <x-hub::button type="button" theme="gray" wire:click="$set('showImageSelectModal', false)">{{
                  __('adminhub::global.cancel') }}</x-hub::button>
                <x-hub::button type="button" :disabled="!$imageToSelect" wire:click.prevent="selectImage">
