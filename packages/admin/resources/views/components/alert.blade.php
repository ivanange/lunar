...
<div @class([ 'rounded-md p-4' , 'bg-primary-50'=> !$level,
  ...
  <div class="flex items-center">
    <div class="flex-shrink-0">
      <div @class([ 'text-yellow-400'=> $level == 'warning',
        'text-red-500' => $level == 'danger',
        'text-primary-500' => !$level,
        ])
        >
        @switch($level)
        @case('danger')
    ...
    <div class="flex-1 ml-3 md:flex md:justify-between w-full">
      <div @class([ 'text-sm' , 'text-yellow-700'=> $level == 'warning',
        'text-red-700' => $level == 'danger',
        'text-primary-700' => !$level,
        ])
        >
        {{ $slot }}
      </div>
