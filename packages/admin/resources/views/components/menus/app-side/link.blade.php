<div @class([ 'group flex space-x-2' , 'justify-between items-center'=> $hasSubItems
    ])
    >
    <a href="{{ route($item->route) }}" @class([ 'flex items-center gap-2 p-2 rounded w-full text-sm font-medium'
    ...
    @if ($hasSubItems)
    <button x-cloak x-on:click.prevent="showSubMenu = !showSubMenu"
