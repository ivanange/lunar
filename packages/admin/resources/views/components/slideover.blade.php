<div class="fixed inset-0 z-75 !m-0" role="dialog" aria-modal="true"
    x-data="{ show: @entangle($attributes->wire('model')) }" x-cloak x-show="show">
    <div class="absolute inset-0">
        <div x-show="show" x-cloak class="absolute inset-0 transition-opacity bg-gray-500 bg-opacity-75"
            aria-hidden="true" x-on:click="show = false" x-transition:enter="ease-in-out duration-500"
        ...
        <form wire:submit.prevent="{{ $form }}">
            ...
            <div class="fixed inset-y-0 right-0 flex max-w-full pl-10">
                <div x-show="show" x-trap.noscroll="show" x-cloak
                    ...
                    <div class="flex flex-col h-full py-6 pb-20 overflow-y-scroll bg-white shadow-xl">
                        ...
                        <div class="relative flex-1 px-4 mt-6 sm:px-6" x-ref="main">
                            {{ $slot }}
                        </div>
                    </div>
